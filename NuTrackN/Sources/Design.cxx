...
CommandPrompt::CommandPrompt(QWidget *parent) : QPlainTextEdit(parent) {
  ...
  // Cross-platform monospace font ensuring ASCII tables and uncertainties align
  // perfectly
  QFont monoFont = QFontDatabase::systemFont(QFontDatabase::FixedFont);
  monoFont.setPointSize(9);
  setFont(monoFont);

  // Cap line buffer to prevent memory exhaustion during continuous data
  // acquisition
...
void addCommandPrompt(QMainCanvas *m) {
  ...
  // Proportional height with minimum constraints to allow flexible window
  // resizing
